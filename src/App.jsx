...
const SelectCategoryResults = lazy(() => import("./pages/SelectCategoryResults"));
const MainCartPage = lazy(() => import("./pages/MainCartPage"));
...
const SaveForLetterProduct = lazy(() => import("./pages/SaveForLetterProduct"));
const IsLoggedIn = lazy(() => import("./pages/IsLoggedIn"));
const AdminLogin = lazy(() => import("./AdminPannel/AdminLogin"));


/* ---------- Admin ---------- */
const DashboardMainPage = lazy(() => import("./AdminPannel/DashboardMainPage.tsx"));
const DashboardHomePage = lazy(() => import("./AdminPannel/DashboardHomePage"));
const ProductTable = lazy(() => import("./AdminPannel/DataTable/Product/ProductTable"));
const CategoryTable = lazy(() => import("./AdminPannel/DataTable/Category/CategoryTable"));
const SubcategoryTable = lazy(() => import("./AdminPannel/DataTable/Subcategory/SubcategoryTable"));
const BrandTable = lazy(() => import("./AdminPannel/DataTable/Brands/BrandTable"));
const OrderTable = lazy(() => import("./AdminPannel/DataTable/Orders/OrderTable"));
const Notifications = lazy(() => import("./AdminPannel/Notifications"));
const Settings = lazy(() => import("./pages/Settings"));
const Help = lazy(() => import("./AdminPannel/Help"));
const RoleTable = lazy(() => import("./AdminPannel/Role/RoleTable"));
const PermissionTable = lazy(() => import("./AdminPannel/Permission/PermissionTable"));
const UsersTable = lazy(() => import("./AdminPannel/User/UsersTable"));
const DashboardBanner = lazy(() => import("./AdminPannel/Banner/DashboardBanner"));
const Poster = lazy(() => import("./AdminPannel/Poster/Poster"));
      ...
      <Suspense fallback={<FullPageLoader />}>
        <Routes>
          ...
          <Route path="/" element={<Mainpage />}>
            ...
            <Route path=":productId" element={<ProductDetail />} />
            <Route path="searchResult/:query" element={<SearchResult />} />
            <Route path="selectCategoryResult/:categoryID" element={<SelectCategoryResults />} />
            <Route path="mainCartPage" element={<MainCartPage />} />
            <Route path="myWishList" element={<Wishlist />} />
            <Route path="orderSummaryPage" element={<OrderSummaryPage />} />
            <Route path="checkout" element={<Checkout />} />
